                    ...
                    >
                        ...
                        <div className="relative z-20 p-8">
                            ...
                            >
                                ...
                                <motion.a href="/forgot-password" className="block text-sm text-green-400 mt-1 cursor-pointer hover:underline text-right" variants={itemVariants} initial="hidden" animate="visible">
