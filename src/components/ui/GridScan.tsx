...
export const GridScan = ({
    ...
    useEffect(() => {
        ...
        const tick = () => {
            ...
            (rafRef as any).current = requestAnimationFrame(tick);
        };
        (rafRef as any).current = requestAnimationFrame(tick);
    ...
    useEffect(() => {
        ...
        const start = async () => {
            ...
            const detect = async (ts: number) => {
                ...
                if (ts - lastDetect >= 33) {
                    ...
                    try {
                        ...
                        if (res && res.detection) {
                            ...
                            const tip = (nose as any)[nose.length - 1] || nose[Math.floor(nose.length / 2)];
                ...
                if ('requestVideoFrameCallback' in (HTMLVideoElement.prototype as any)) {
